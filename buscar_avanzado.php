    ...
    <html lang="en">
        ...
        <br>
            <header>
                ...
                <h3>Busqueda avanzada de artículos ⇒ </h3>
            </header>
            <div class="container">
                <form method="post" action="buscar_avanzado.php"><br>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <label class="form-label">Ingrese unidades del artículo</label>
                            <input type="number" name="busqueda2" class="form-control" autocomplete="off"><br>
...
if ($_POST) {
    ...
    $consulta = "SELECT codigo, nombre, unidades, precio, codigocat, foto FROM articulos WHERE Nombre LIKE '%$busqueda%' AND Unidades ='$busqueda2'";
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        echo "<table>";
        echo "<td><b> 🛆 No se han encontrado artículos para su busqueda</td></b>";
        echo ("</table>");
    }
